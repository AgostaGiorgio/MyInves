...
@api_router.get("/exchange-rates", response_model=list[ExchangeRate], status_code=201)
@inject
...
@api_router.get("/assets", response_model=list[AssetWithPrice], status_code=201)
@inject
...
@api_router.get("/assets/{id}/icon", response_model=AssetIcon, status_code=201)
@inject
...
@api_router.get("/portfolio", response_model=list[PortfolioItemView], status_code=201)
@inject
